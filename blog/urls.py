...
urlpatterns = [
    ...
    path('general_posts/', views.ViewMoreGeneral.as_view(), name='general_posts'),
    path('advice_posts/', views.ViewMoreTraining.as_view(), name='advice_posts'),
    path('exercise_posts/', views.ViewMoreExercise.as_view(), name='exercise_posts'),
